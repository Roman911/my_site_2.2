...
export const name = ['Введіть логін', 'Введите логин', 'Enter login'];
export const password = ['Введіть пароль', 'Введите пароль', 'Enter password'];
export const error = ['Неправильний логін чи пароль', 'Неверный логин или пароль', 'Wrong login or password'];